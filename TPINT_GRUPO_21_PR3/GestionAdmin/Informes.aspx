<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Informes.aspx.cs" Inherits="TPINT_GRUPO_21_PR3.GestionAdmin.Informes" %>
...
<body style="background-color: #f8f9fa;">
    ...
    <div style="padding: 50px; margin: 50px;">
        <ul class="nav nav-tabs" style=" min-width: 1000px;">
            ...
            <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="Informes.aspx">Informes</a>
            </li>
        </ul>
